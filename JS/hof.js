...
// Ques: Find largest element in array using reduce

// var arr = [10, -5, 6, 28, 56, 12, 456];
// function largestVal(acc, cur) {
// console.log("Before");
// console.log(acc);
// console.log(cur);
// let max = acc;
...
//   return max;
// }
// let Lvalue = arr.reduce(largestVal);
// console.log(Lvalue);

// A better way to find Largest value in array
// var arr = [10, -5, 6, 28, 56, 12, 456];
// function largestVal(acc, cur) {
//   if (cur > acc)
//     acc = cur;
...
var cNm_Cap = worldCapitals.map(findNMCap);
function findNMCap(obj) {
...
function popLessThan5(obj) {
  if (obj.population < "5cr")
    return true;
}
function getCountryNm(obj) {
  return obj.country;
}

var population = worldCapitals.filter(popLessThan5).map(getCountryNm);
