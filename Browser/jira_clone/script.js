...
function handlePriorityColor(ticketCont, id) {
  ...
  ticketColor.addEventListener("click", function () {
    let currTicketColor = ticketColor.classList[1];       //getting current color of ticket
    let currTicketColorIdx = colors.indexOf(currTicketColor);     //getting index of current color
    let newTicketColorIdx = (currTicketColorIdx + 1)%colors.length;         //updating index of color to point to next color
    let newTicketColor = colors[newTicketColorIdx];                         //getting color of new index we updated
    ticketColor.classList.remove(currTicketColor);                          //removing current  color of ticket
    ticketColor.classList.add(newTicketColor);                              //removing current  color of ticket
...
function handleLock(ticketCont, id) {
  ...
  console.log("Here is ticketLock"+ticketLock);
